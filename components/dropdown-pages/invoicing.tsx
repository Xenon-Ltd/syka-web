    ...
    <>
      ...
      <section className="px-5 pt-6 pb-24 sm:px-6 lg:pt-8 lg:pb-28 xl:px-0">
        <div className="mx-auto max-w-[1292px]">
          ...
          <div className="mt-18 grid gap-10 lg:mt-24 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-center lg:gap-20 xl:gap-24">
            <div className="mx-auto w-full text-center lg:mx-0 lg:max-w-[500px] lg:text-left">
              ...
              <div className="mx-auto mt-8 max-w-[520px] space-y-5 text-left lg:mx-0 lg:max-w-none">
                {steps.map((step, index) => (
                  <div key={step.title} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[17px] leading-[1.35] font-medium text-[#42536A]">
                        {step.title}
                      </p>
                      <p className="mt-1.5 max-w-[490px] text-[14px] leading-[1.55] text-[#9AA7BC]">
                        {step.description}
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex w-full justify-center lg:justify-end">
              <Image
                ...
                className="w-full max-w-[620px] rounded-[22px] shadow-[0_20px_45px_rgba(61,71,86,0.12)]"
              />
            </div>
          </div>
        </div>
