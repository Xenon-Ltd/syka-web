    ...
    <>
      ...
      <section className="px-5 pt-6 pb-24 sm:px-6 lg:pt-8 lg:pb-28 xl:px-0">
        <div className="mx-auto max-w-[1292px]">
          ...
          <div className="mt-18 grid items-center gap-10 lg:mt-24 lg:grid-cols-[minmax(0,0.84fr)_minmax(0,1fr)] lg:items-center lg:gap-16">
            ...
            <div className="w-full max-w-[560px] rounded-[18px] bg-[#23284F] p-6 text-white shadow-[0_20px_45px_rgba(24,28,61,0.22)] lg:max-w-none lg:p-8">
              ...
              <div className="mt-5 space-y-3">
                {cardRows.map((card) => (
                  <div
                    key={card.title}
                    className="flex items-center justify-between rounded-xl bg-white/12 px-4 py-3"
                  >
                    ...
                    <span
                      className={`rounded-full px-2.5 py-1 text-[10px] font-semibold ${card.statusClass}`}
                    >
                      {card.status}
                    </span>
                  </div>
              ...
              <div className="mt-5 grid grid-cols-3 gap-3 rounded-xl bg-white/12 px-4 py-4">
                <div>
                  <p className="text-[10px] text-white/55">Cards Issued</p>
                  <p className="mt-2 text-[20px] leading-none font-semibold text-white">
                    3
                  </p>
                </div>
                <div>
                  <p className="text-[10px] text-white/55">Spent This Month</p>
                  <p className="mt-2 text-[20px] leading-none font-semibold text-white">
                    $4,230
                  </p>
                </div>
                <div>
                  <p className="text-[10px] text-white/55">Alerts</p>
                  <p className="mt-2 text-[20px] leading-none font-semibold text-white">
                    0
                  </p>
                </div>
