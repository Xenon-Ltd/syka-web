...
export default function ApiDocumentationPage() {
  return (
    <section className="mt-8 flex min-h-[85vh] items-center px-5 sm:px-6 xl:mt-0 xl:px-0">
      <div className="mx-auto w-full max-w-[1292px] px-6 py-8 sm:px-8 sm:py-10 xl:px-10 xl:py-12">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-8 xl:grid-cols-2">
          ...
          <div className="relative min-w-0">
            <div className="overflow-hidden rounded-[14px]">
              <Image
                ...
                className="mx-auto w-full max-w-[800px] rounded-[14px] lg:max-w-full"
                sizes="(max-width: 1023px) 100vw, (max-width: 1279px) 52vw, 500px"
                priority
              />
            </div>
          </div>
