...
const Footer = () => {
  return (
    <footer className="relative flex flex-col justify-between h-[560px] w-full bg-xenon-primary">
      <div className="absolute bottom-[80%] flex-1 left-1/2 -translate-x-1/2 h-[370px] items-center rounded-3xl w-[1211px] mx-auto flex flex-row bg-white shadow-xenon shadow-[#2121213a]">
