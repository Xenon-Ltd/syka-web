      ...
      <div className="flex gap-6">
        ...
        <div className="w-1/2">
          <div className="flex flex-col gap-6">
            ...
            <div className="text-white p-8 rounded-3xl bg-[#29AAE1] flex items-center justify-between">
            ...
            <div className="p-8 rounded-3xl bg-gray-50 flex items-center justify-between">
              <div className="flex-1 pr-6">
        ...
        <div className="text-white px-8 pt-8 rounded-3xl w-1/2 bg-gradient-to-br from-[#4169B8] via-[#5850B6] to-[#6F38B4]">
          <div className="mb-8">
          ...
          <div className="flex justify-center mt-12">
            <Image src={SpendableBalance} alt="Spendable Balance" width={420} />
          </div>
        </div>
      </div>

      {/* Your Local Presence Card */}
      <div className="mt-6 p-8 rounded-3xl bg-[#D4F4F4] flex items-center justify-between">
        <div className="flex-1 pr-6">
          <h3 className="font-bold text-2xl text-gray-900 mb-3">
